...
async function testDobbeltregistrering() {
  ...
  try {
    ...
    if (second.error) {
      ...
      testLogg(
        "OBS: Databasen stoppet ikke direkte insert. Appen stopper dobbeltregistrering i hand-timer.js."
      );
    }
...
async function testFakturaSperre() {
  ...
  try {
    ...
    testLogg("Denne testen leser grunnlag. Selve sperre styres av hand-faktura.js.", true);
