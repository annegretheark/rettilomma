...
(function(){
  ...
  function isAdmin(){
    var r = low(window.innloggetRolle || window.handInnloggetRolle || localStorage.getItem('handInnloggetRolle') || localStorage.getItem('rilRolle') || localStorage.getItem('rolle'));
    return r === 'admin' || r === 'sysadmin' || r === 'systemadmin';
  }
