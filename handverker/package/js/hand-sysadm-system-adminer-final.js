...
(function(){
  ...
  // Tidlig anti-blink for greknuts fra lagret e-post, før Supabase-sjekken er ferdig.
  try{ var se = storedEmail(); if(isGreknuts(se)) applySysadm(se); }catch(e){}
