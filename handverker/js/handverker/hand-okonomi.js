...
(function okonomiInstallerMobilCss() {
  ...
  style.textContent = `
    ...
    #okonomiOversikt .okonomi-tabell td:nth-child(1) { min-width: 78px; max-width: 78px; }
    #okonomiOversikt .okonomi-tabell th:nth-child(2),
    #okonomiOversikt .okonomi-tabell td:nth-child(2) { min-width: 82px; max-width: 110px; }
    #okonomiOversikt .okonomi-tabell th:nth-child(3),
    #okonomiOversikt .okonomi-tabell td:nth-child(3) { min-width: 52px; max-width: 74px; }
    #okonomiOversikt .okonomi-tabell th:nth-child(4),
    #okonomiOversikt .okonomi-tabell td:nth-child(4) { min-width: 90px; max-width: 130px; }
    #okonomiOversikt .okonomi-tabell th:nth-child(5),
    #okonomiOversikt .okonomi-tabell td:nth-child(5) { min-width: 64px; max-width: 84px; text-align: right; }
    #okonomiOversikt .okonomi-tabell th:nth-child(6),
    #okonomiOversikt .okonomi-tabell td:nth-child(6) { min-width: 70px; max-width: 90px; text-align: right; }

    /* Handlinger er alltid siste kolonne, både i tabellen med 6 og 7 kolonner. */
    #okonomiOversikt .okonomi-tabell th:last-child,
    #okonomiOversikt .okonomi-tabell td:last-child {
      min-width: 172px;
      max-width: 172px;
      width: 172px;
      overflow: visible;
    ...
    @media (max-width: 700px) {
      #okonomiOversikt { font-size: 11.5px; }
      #okonomiOversikt table.okonomi-tabell { font-size: 11px; }
      #okonomiOversikt .okonomi-tabell th,
      #okonomiOversikt .okonomi-tabell td { padding: 2px 3px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(1),
      #okonomiOversikt .okonomi-tabell td:nth-child(1) { min-width: 72px; max-width: 72px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(2),
      #okonomiOversikt .okonomi-tabell td:nth-child(2) { min-width: 62px; max-width: 82px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(3),
      #okonomiOversikt .okonomi-tabell td:nth-child(3) { min-width: 42px; max-width: 58px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(4),
      #okonomiOversikt .okonomi-tabell td:nth-child(4) { min-width: 68px; max-width: 92px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(5),
      #okonomiOversikt .okonomi-tabell td:nth-child(5) { min-width: 58px; max-width: 70px; }
      #okonomiOversikt .okonomi-tabell th:nth-child(6),
      #okonomiOversikt .okonomi-tabell td:nth-child(6) { min-width: 58px; max-width: 70px; }
      #okonomiOversikt .okonomi-tabell th:last-child,
      #okonomiOversikt .okonomi-tabell td:last-child { min-width: 158px; max-width: 158px; width: 158px; }
      #okonomiOversikt .okonomi-mini-knapp { font-size: 9px !important; padding: 3px 3px !important; min-height: 21px !important; min-width: 31px !important; }
      #okonomiOversikt .okonomi-handlinger { width: 154px; max-width: 154px; gap: 2px; }
      #okonomiOversikt .okonomi-status-merke { font-size: 6.5px; padding: 1px 2px; }
    }

    /* === RIL MINST LUFT OKONOMI 2026-06-28 ===
       Kun CSS/layout. Ingen logikk, fakturering, beregning eller database endret. */
    ...
    #okonomiOversikt .okonomi-boks strong{
    ...
    /* Tabell med 6 kolonner: Ikke fakturert samlet */
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(1),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(1){ width:68px !important; max-width:68px !important; }

    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(2),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(2){ width:86px !important; max-width:86px !important; }

    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(3),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(3){ width:58px !important; max-width:58px !important; }

    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(4),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(4){ width:112px !important; max-width:112px !important; }

    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(5),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(5){ width:70px !important; max-width:70px !important; text-align:right !important; }

    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) th:nth-child(6),
    #okonomiOversikt .okonomi-tabell:not(:has(th:nth-child(7))) td:nth-child(6){ width:142px !important; max-width:142px !important; overflow:visible !important; }

    /* Tabell med 7 kolonner: Fakturaer */
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(1),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(1){ width:68px !important; max-width:68px !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(2),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(2){ width:110px !important; max-width:110px !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(3),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(3){ width:70px !important; max-width:70px !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(4),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(4){ width:88px !important; max-width:88px !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(5),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(5){ width:68px !important; max-width:68px !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(6),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(6){ width:70px !important; max-width:70px !important; text-align:right !important; }

    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) th:nth-child(7),
    #okonomiOversikt .okonomi-tabell:has(th:nth-child(7)) td:nth-child(7){ width:142px !important; max-width:142px !important; overflow:visible !important; }
...
function okonomiErReellTime(time) {
  const t = okonomiNormaliserHandTime(time);
  const antall = Number(t.timer || 0);
  const belop = Number(t.sum || t.sum_timer || (antall * Number(t.timepris || 0)) || 0);
  const tekst = String(t.beskrivelse || t.kommentar || t.type || t.utgift_type || "").toLowerCase();

  // hand_time kan inneholde utlegg/refusjon-rader med timer=8 og beløp=0.
  // De skal ikke inn som timer på faktura.
  if (tekst.includes("utlegg") || tekst.includes("refusjon")) return false;

  return antall > 0 && belop > 0;
}

function okonomiErIkkeFakturertTimer(time) {
  const t = okonomiNormaliserHandTime(time);
  if (!okonomiErReellTime(t)) return false;
  // Fasit fra databasen: timer er ikke fakturert når faktura_id er tom.
  return !t.faktura_id;
}


function okonomiNormaliserHandTime(time) {
  const t = Object.assign({}, time || {});
  const timer = Number(t.timer || 0);
  const sumTimer = Number(t.sum_timer || 0);
  let timepris = Number(t.timepris || 0);

  if (!timepris && timer > 0 && sumTimer > 0) {
    timepris = sumTimer / timer;
  }

  t.timer = timer;
  t.timepris = timepris;
  if ((t.sum === undefined || t.sum === null || Number(t.sum) === 0) && sumTimer > 0) {
    t.sum = sumTimer;
  }
  if (!t.beskrivelse && !t.kommentar) {
    t.beskrivelse = "Timer";
  }
  return t;
}

async function okonomiHentHandTimeDirekte({ kundeId = "", kunIkkeFakturert = true, limit = 200 } = {}) {
  ...
  if (kunIkkeFakturert) query = query.is("faktura_id", null);

  const { data, error } = await query;
  if (error) {
    console.error("Kunne ikke hente hand_time direkte:", error);
    alert("Kunne ikke hente timer fra hand_time: " + error.message);
    return [];
  }

  return (data || []).map(okonomiNormaliserHandTime).filter(okonomiErReellTime);
}

async function okonomiTestBareTimerPdf() {
  ...
  let timerListe = await okonomiHentHandTimeDirekte({ kundeId, kunIkkeFakturert: true, limit: 50 });

  // Fallback for test: hvis alle timer er fakturert, vis likevel siste timer så vi får testet feltmapping/PDF.
  if (!timerListe.length) {
    timerListe = await okonomiHentHandTimeDirekte({ kundeId, kunIkkeFakturert: false, limit: 50 });
  }

  if (!timerListe.length) {
    alert("TEST BARE TIMER: Fant ingen rader i hand_time med timer > 0" + (kundeId ? " for valgt kunde." : "."));
    return;
  }

  const kundeFraListe = (window.kunder || []).find(k => String(k.id || "") === String(timerListe[0].kunde_id || ""));
  const kunde = kundeFraListe || {
    id: timerListe[0].kunde_id || null,
    navn: timerListe[0].kunde_navn || "Testkunde",
    kundenr: timerListe[0].kunde_nr || ""
  };

  if (typeof lagEnFakturaPdf !== "function") {
    alert("TEST BARE TIMER: Fant ikke lagEnFakturaPdf.");
    return;
  }

  console.log("TEST BARE TIMER hand_time:", timerListe.map(t => ({ id: t.id, dato: t.dato, kunde_id: t.kunde_id, timer: t.timer, sum_timer: t.sum_timer, sum: t.sum, timepris: t.timepris })));
...
function okonomiLagSamledeFakturaGrupper(timerListe, varerListe, utleggListe) {
  ...
  (utleggListe || []).forEach(u => {
    const kundeId = okonomiRadKundeId(u);
    const prosjektId = okonomiProsjektId(u);
    const g = hentGruppe(kundeId, prosjektId);
    g.utlegg.push(u);
...
async function okonomiFakturerSamletGruppe(gruppe) {
  ...
  const timerIds = gruppe.timer.map(t => t.id).filter(v => v !== undefined && v !== null);
  ...
  if (timerIds.length) {
    ...
    // Oppdater bare feltet som faktisk finnes, ellers feiler hele timekoblingen.
    const { error } = await supabaseClient
      .from("hand_time")
      .update({ faktura_id: fakturaId })
      .in("id", timerIds);
    if (error) alert("Faktura ble laget, men timer ble ikke oppdatert: " + error.message);
  }
  ...
  alert("Samlet faktura opprettet: " + fakturanr);

  // Vis kopi av den reelle fakturaen direkte med samme data som nettopp ble fakturert.
  // Dette unngår at timer forsvinner i et nytt/feil databaseoppslag.
  if (typeof lagEnFakturaPdf === "function") {
    const kunde = (window.kunder || []).find(k => String(k.id || "") === String(kundeId)) || {
      id: kundeId,
      navn: kundeTekst
    };
    const firma = typeof hentFirmaData === "function" ? await hentFirmaData() : (window.firma || {});
    await lagEnFakturaPdf(
      kunde,
      (gruppe.timer || []).map(okonomiNormaliserHandTime).filter(okonomiErReellTime),
      String(fakturaDato.toISOString()).slice(0, 7),
      firma,
      true,
      fakturanr,
      gruppe.varer || [],
...
async function okonomiVisFakturaFraRad(type, indeks) {
  ...
  // Ikke-fakturerte samlelinjer skal vise forhåndsvisning av reell faktura i vinduet.
  if (type === "Samlet" || rad._okonomiSamlet) {
    if (typeof lagEnFakturaPdf !== "function") {
      alert("Fant ikke PDF-funksjonen.");
      return;
    }
    const kundeId = String(rad.kunde_id || "");
    const kunde = (window.kunder || []).find(k => String(k.id || "") === String(kundeId)) || {
      id: kundeId,
      navn: okonomiKundeNavn(kundeId, "kunde " + kundeId)
    };
    const firma = typeof hentFirmaData === "function" ? await hentFirmaData() : (window.firma || {});
    await lagEnFakturaPdf(
      kunde,
      (rad.timer || []).map(okonomiNormaliserHandTime).filter(okonomiErReellTime),
      "FORHÅNDSVISNING",
      firma,
      true,
      "FORHÅNDSVISNING",
...
async function visOkonomiOversikt() {
  ...
  if (typeof lastTimer === "function") {
    try { await lastTimer(); } catch (e) { console.warn("lastTimer feilet, henter hand_time direkte:", e); }
  }

  // Viktig: økonomioversikten skal bruke den faktiske tabellen hand_time.
  // window.timer kan være tom/feil cache, derfor hentes timer direkte fra Supabase.
  let alleTimer = await okonomiHentHandTimeDirekte({ kundeId, kunIkkeFakturert: false, limit: 1000 });
  if (!alleTimer.length && Array.isArray(window.timer)) {
    alleTimer = window.timer.map(okonomiNormaliserHandTime);
  }
...
window.okonomiTestBareTimerPdf = okonomiTestBareTimerPdf;
window.okonomiHentHandTimeDirekte = okonomiHentHandTimeDirekte;
...
/* === OKONOMI 2.1.3 - aktiv patch: ryddige knapper + mobilkort === */
(function okonomi213InstallerCss() {
  if (document.getElementById("okonomi213Css")) return;
  const style = document.createElement("style");
  style.id = "okonomi213Css";
  style.textContent = `
    #okonomiOversikt{
      width:100% !important;
      max-width:100% !important;
    ...
    #okonomiOversikt:before{
      content:"Økonomi 2.1.3 aktiv";
      display:inline-flex;
      margin:8px 0 10px;
      padding:5px 10px;
      border-radius:999px;
    ...
    #okonomiOversikt .okonomi-tabell th{font-size:12px !important; opacity:.8; text-align:left !important;}
    #okonomiOversikt .okonomi-tabell td:last-child,
    #okonomiOversikt .okonomi-tabell th:last-child{width:270px !important; min-width:270px !important; max-width:270px !important;}
    #okonomiOversikt .okonomi-handlinger{
    ...
    #okonomiOversikt .okonomi-mini-knapp.okonomi-vis{background:#2563eb !important;}
    #okonomiOversikt .okonomi-mini-knapp.okonomi-fakt{background:#16a34a !important;}
    #okonomiOversikt .okonomi-mini-knapp.okonomi-purr{background:#f59e0b !important; color:#111827 !important;}
    #okonomiOversikt .okonomi-mini-knapp.okonomi-bet{background:#22c55e !important; color:#052e16 !important;}
    #okonomiOversikt .okonomi-mini-knapp.okonomi-kred{background:#ef4444 !important;}
    #okonomiOversikt .okonomi-mini-knapp.okonomi-kopi{background:#64748b !important;}
    #okonomiOversikt .okonomi-status-merke{
      font-size:11px !important;
      padding:4px 8px !important;
      line-height:1.1 !important;
    }
    #okonomiOversikt .okonomi-kortliste{display:none;}
    #okonomiOversikt .okonomi-kort{
    ...
    #okonomiOversikt .okonomi-kort-topp,
    #okonomiOversikt .okonomi-kort-linje{
      display:flex;
    ...
    #okonomiOversikt .okonomi-kort-kunde{font-weight:800; font-size:15px;}
    #okonomiOversikt .okonomi-kort-belop{font-weight:900; font-size:16px; text-align:right;}
    #okonomiOversikt .okonomi-kort-dato,
    #okonomiOversikt .okonomi-kort-tekst,
    #okonomiOversikt .okonomi-kort-ekstra{opacity:.82;}
    #okonomiOversikt .okonomi-kort-valg{padding-top:8px;}
    @media (max-width:760px){
      #okonomiOversikt .okonomi-grid{grid-template-columns:1fr 1fr !important; gap:8px !important;}
      #okonomiOversikt .okonomi-boks{padding:10px !important;}
      #okonomiOversikt .okonomi-boks strong{font-size:16px !important;}
      #okonomiOversikt .okonomi-scroll{display:none !important;}
      #okonomiOversikt .okonomi-kortliste{display:block !important;}
      #okonomiOversikt .okonomi-mini-knapp{flex:1 1 auto; min-height:38px !important; padding:8px 10px !important;}
      #okonomiOversikt .okonomi-handlinger{display:grid !important; grid-template-columns:1fr 1fr; gap:7px !important;}
    }
    @media (max-width:420px){
      #okonomiOversikt .okonomi-grid{grid-template-columns:1fr !important;}
      #okonomiOversikt .okonomi-handlinger{grid-template-columns:1fr;}
    }
  `;
  document.head.appendChild(style);
})();
...
function okonomiBetaltKnapp(f) {
  ...
  const fakturanr = okonomiHarFakturanr(f);
  if (!fakturanr) return "";
  return `<button type="button" class="secondary okonomi-mini-knapp okonomi-bet" onclick="event.stopPropagation(); okonomiSettBetalt('${okonomiTryggJs(fakturanr)}', ${Number(f?.inkl_mva || f?.total || 0)})">Sett betalt</button>`;
}
...
function okonomiPurringKnapp(f) {
  ...
  const fakturanr = okonomiHarFakturanr(f);
  if (!fakturanr) return "";
  return `<button type="button" class="secondary okonomi-mini-knapp okonomi-purr" onclick="event.stopPropagation(); lagPurringFraOkonomi('${okonomiTryggJs(fakturanr)}')">Purr</button>`;
}

function okonomiKreditnotaKnapp(f) {
  const status = okonomiVisStatus(f);
  const fakturanr = okonomiHarFakturanr(f);
  if (status === "Kreditert" || !fakturanr) return "";
  return `<button type="button" class="secondary okonomi-mini-knapp okonomi-kred" onclick="event.stopPropagation(); okonomiLagKreditnota('${okonomiTryggJs(fakturanr)}')">Krediter</button>`;
}

function okonomiVisKnapp(type, indeks, rad) {
  return `<button type="button" class="secondary okonomi-mini-knapp okonomi-vis" data-okonomi-vis="1" data-okonomi-type="${okonomiTryggTekst(type)}" data-okonomi-indeks="${Number(indeks)}" onclick="event.stopPropagation(); okonomiVisFakturaFraRad('${okonomiTryggJs(type)}', ${Number(indeks)})">Forhåndsvis</button>`;
}

function okonomiFakturerKnapp(type, indeks, rad) {
  const status = okonomiVisStatus(rad);
  if (status !== "Ikke fakturert") return "";
  return `<button type="button" class="secondary okonomi-mini-knapp okonomi-fakt" onclick="event.stopPropagation(); okonomiFakturerRad('${okonomiTryggJs(type)}', ${Number(indeks)})">Fakturer</button>`;
}

function okonomiHandlingerHtml(type, rad, indeks) {
  const status = okonomiVisStatus(rad);
  const deler = [okonomiVisKnapp(type, indeks, rad)];
  if (status === "Ikke fakturert") {
    deler.push(okonomiFakturerKnapp(type, indeks, rad));
  } else {
    deler.push(okonomiKreditnotaKnapp(rad));
...
function okonomiLagTabell(tittel, rader, kolonner, tomTekst, klikkType) {
  ...
  const body = rader.map((rad, indeks) => {
    ...
    const celler = kolonner.map(k => {
      const innhold = okonomiKolonneInnhold(k, rad, indeks);
      const erValg = String(k.tittel || "").toLowerCase().includes("valg") || String(k.tittel || "").toLowerCase().includes("handling");
      return `<td${erValg ? ' onclick="event.stopPropagation();"' : ''}>${innhold}</td>`;
    }).join("");
    return `<tr class="klikkbar-okonomi" role="button"${klikk}>${celler}</tr>`;
  }).join("");

  const kort = rader.map((rad, indeks) => okonomiLagKompaktRad(tittel, rad, indeks, kolonner, klikkType)).join("");
  ...
  return `
    ...
    <div class="okonomi-kortliste">${kort}</div>
  `;
}

window.okonomiHandlingerHtml = okonomiHandlingerHtml;
window.okonomiVisKnapp = okonomiVisKnapp;
window.okonomiFakturerKnapp = okonomiFakturerKnapp;
window.okonomiBetaltKnapp = okonomiBetaltKnapp;
window.okonomiPurringKnapp = okonomiPurringKnapp;
window.okonomiKreditnotaKnapp = okonomiKreditnotaKnapp;
