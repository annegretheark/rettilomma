...
(function () {
  ...
  function styrImportForRolle() {
    // Import-knappen skal ikke skjules her. Tidligere rollelogikk skjulte
    // importfeltet med MutationObserver, som ga blinking og gjorde at
    // knappen forsvant etter at siden var tegnet.
    [
      "patchImportLagerWrap",
      "importBilLagerBunnOmrade",
      "importBilLagerFil",
      "importBilLagerKnapp",
      ...
      const el = hent(id);
      if (!el) return;
      const blokk = el.closest("#patchImportLagerWrap") || el.closest("#importBilLagerBunnOmrade") || el;
      vis(blokk);
    });
  }
