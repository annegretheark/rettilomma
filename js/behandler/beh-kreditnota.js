console.log("beh-kreditnota.js lastet");
...
async function lagBehKreditnota() {
  ...
  const oppdaterBehandlingerRes = await supabaseClient
  ...
  if (oppdaterBehandlingerRes.error) {
    kreditMelding(oppdaterBehandlingerRes.error.message, true);
    return;
  }
