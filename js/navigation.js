...
function visHovslagerModul() {
  if (typeof modulErAktiv === "function" && !modulErAktiv("hovslager")) {
    alert("Hovslager-modulen er ikke aktivert. Gå til Moduler og slå den på først.");
    return;
  }
...
function visVeterinaerModul() {
  if (typeof modulErAktiv === "function" && !modulErAktiv("veterinaer")) {
    alert("Veterinær-modulen er ikke aktivert. Gå til Moduler og slå den på først.");
    return;
  }
...
window.visHovslagerModul = visHovslagerModul;
window.visVeterinaerModul = visVeterinaerModul;
